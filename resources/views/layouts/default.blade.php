...
@endif
    ...
    <div class="logo_desktop"><img data-src="‪{{ asset('/assets/bilder/kalle_logo.png') }}" alt="logo"/></div>
    </nav>

    <div class="nav_mobil">
      <div class="active"><a href="/" class="bilde_nav"><img data-src="‪{{ asset('/assets/bilder/kalle_logo.png') }}"/></a></div>
      <div id="nav_linkar">
        <a href="/">Heim</a>
