...
@endif
    ...
    <a href="/"><div class="logo_desktop"><img src="{{ asset('images/kalle_nav.png') }}" alt="logo" /></div></a>
    </nav>
...
<footer id="footer">
  ...
  <div class="footer_p">
    ...
    <div class="logo_footer"><img class="footer_bilde" src="{{ asset('images/footer_logo.png') }}" /></div>
  </div>
