...
@endif
    ...
    <div class="nav_mobil">
      <div class="active"><a href="/" class="bilde_nav"><img src="https://images.unsplash.com/photo-1512790182412-b19e6d62bc39?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=889&q=80"></a></div>
      <div id="nav_linkar">
        <a href="/">Heim</a>
        ...
        <div id="nav_stadar">
          @foreach ($subpages as $subpage)
            <a href="/{{ strtolower($subpage->title) }}">{{ $subpage->title }}</a>
          @endforeach
        </div>
        <a href="#kontakt_meg" class="understrek kontakt_a">Kontakt meg</a>
      </div>
